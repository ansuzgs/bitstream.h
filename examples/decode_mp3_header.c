...
static const int bitrate_table[] = {0,   32,  40,  48,  56,  64,  80,  96,
                                    112, 128, 160, 192, 224, 256, 320, -1};

static const int samplerate_table[] = {44100, 48000, 32000, -1};

static const char *channel_modes[] = {"Stereo", "Joint Stereo", "Dual Channel", "Mono"};

static const char *emphasis_modes[] = {"None", "50/15 ms", "reserved", "CCIT J.17"};
